    ...
    {   
       try
       {
          conn = DBConnection.getInstance().getConnect();
           ...
           String qry;
           qry = "insert into AddressBook values ('"+person.getName()+"','"+person.getMob()+"','"+person.getEmail()+"','"+person.getGender()+"','"+person.getFb()+"')";
//           System.out.println("qurries is"+qry);
        ...
        try {
            ...
            while(rs.next()){
             ...
             detailPanel.setMobile(rs.getString("mob"));
              detailPanel.setGender(rs.getString("gender"));
               detailPanel.setFb(rs.getString("fb"));
