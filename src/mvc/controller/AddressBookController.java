    ...
    private void openAdd(){   
       view.getMainGUIFrame().setVisible(false);
        ...
        choiceListener = new ActionListener() {
            ...
            String gender=contactDetailsPanel.getGenderField().getText(); 
             String fb=contactDetailsPanel.getFbField().getText(); 
            flag = validate();
            if(flag)
            {    
             Person person = new Person();
             person.setData(name,mobile,email,gender,fb);
   ...
   */
    ...
    private void openEdit(){
        ...
        dialog.getPanel().seteMail(detailPanel.geteMailField().getText());
         dialog.getPanel().setGender(detailPanel.getGenderField().getText());
        view.getMainGUIFrame().setVisible(false);
        choiceListener = new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
    ...
    public void loadPersons()       
    {
        ...
        nlp.getJList().addListSelectionListener(new ListSelectionListener()
         ...
         detailPanel.getGenderField().setEditable(false);
         detailPanel.getFbField().setEditable(false);
        }
    }  //loadPersons ends
